...
//		printf("----------------------------- \n");
  ...
  {
    DB.PressAim = Value;
    //if((DB.PressValDis[1] + DB.PressValDis[2] + DB.PressValDis[3] + DB.PressValDis[4] + DB.PressValDis[5])/5 - DB.PressAim <= -10 
		//&& (DB.PressValDis[1] + DB.PressValDis[2] + DB.PressValDis[3] + DB.PressValDis[4] + DB.PressValDis[5])/5 - DB.PressAim >= 10)
		if((DB.PressValDis[1] + DB.PressValDis[2] + DB.PressValDis[3] + DB.PressValDis[4] + DB.PressValDis[5])/5 - DB.PressAim >= -10 
		&& (DB.PressValDis[1] + DB.PressValDis[2] + DB.PressValDis[3] + DB.PressValDis[4] + DB.PressValDis[5])/5 - DB.PressAim <= 10)
    {
    ...
    else
    {
      ...
      if(DB.PressAim > 0) DB.PressAimTmp = DB.PressAim + 20;
      if(DB.PressAim < 0) DB.PressAimTmp = DB.PressAim - 20;
    }
  }
