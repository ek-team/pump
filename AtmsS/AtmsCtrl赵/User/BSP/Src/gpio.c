...
void GPIO_Init(void)														
{
  ...
  GPIO_InitStruct.Pin   = PUMP1_EN_GPIO_PIN;
  GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PUMP1_EN_GPIO, &GPIO_InitStruct);
	
  GPIO_InitStruct.Pin   = PUMP2_EN_GPIO_PIN;
  GPIO_InitStruct.Mode  = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PUMP2_EN_GPIO, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin   = FG1_GPIO_PIN;
  GPIO_InitStruct.Mode  = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull  = GPIO_PULLUP;
  HAL_GPIO_Init(FG1_GPIO, &GPIO_InitStruct);		
	
  GPIO_InitStruct.Pin   = FG2_GPIO_PIN;
  GPIO_InitStruct.Mode  = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull  = GPIO_PULLUP;
  HAL_GPIO_Init(FG2_GPIO, &GPIO_InitStruct);
}
