...
//}
  if(Frame == 0x0206 && Addr == 0x0001)
  {
    ...
    switch(Value)
    {
      ...
      case 0x0011: HAL_GPIO_WritePin(PUMP_EN_GPIO,PUMP_EN_GPIO_PIN,GPIO_PIN_SET);break;
      case 0x0012: HAL_GPIO_WritePin(PUMP_EN_GPIO,PUMP_EN_GPIO_PIN,GPIO_PIN_RESET);break;
      default:break;
    }
  }
